...
//para calculo fecha en milisegundos, tomanando en cuenta dias
function getAge(birthday) {
    var actualDate = Date.now();
    var ageDifMs = actualDate - birthday;
    var ageDate = new Date(ageDifMs);
    var dias = Math.floor(ageDifMs / (1000 * 60 * 60 * 24));
    var milisegundos = dias * 86400000;
    console.log(milisegundos + " cumplidos");
}
